...
//command object : db table의 컬럼명과 필드명을 일치시킴
//html태그 안 form태그 input의 name도 필드명과 일치시킴
public class Member implements java.io.Serializable{
	...
	public Member(String userid, String userpwd, String username, String gender, int age, String phone, String email,
			String hobby, String etc, Date enroll_date, Date lastmodified, String login_ok) {
		super();
		this.userid = userid;
