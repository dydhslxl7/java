...
public class Board implements java.io.Serializable{
		...
		public Board(int boardNum, String boardWriter, String boardTitle, String boardContent,
				String boardOriginalFileName, String boardRenameFileName, int boardRef, int boardReplyRef,
				int boardLevel, int boardReplySeq, int boardReadCount, Date boardDate) {
			super();
			this.boardNum = boardNum;
